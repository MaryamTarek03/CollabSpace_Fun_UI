...
export default function FilesModal() {
    ...
    return (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
            ...
            <div className="relative w-[95vw] max-w-5xl bg-white border-4 border-black rounded-3xl shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] flex flex-col h-[85vh] max-h-[750px] animate-in zoom-in-95 duration-200">
